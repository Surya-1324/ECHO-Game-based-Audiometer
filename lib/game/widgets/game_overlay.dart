                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (details) {
                            ...
                            if(mystorage.isplaying && mystorage.leftrightlist.length!=mystorage.movementdtlist.length){
                              mystorage.movementlist.add(-1);
                              mystorage.movementdtlist.add(DateTime.now());
                            }

                            if(mystorage.leftrightlist.length!=mystorage.movementlist.length && mystorage.movementlist.isNotEmpty)
                            {
                              var len=mystorage.leftrightlist.length-mystorage.movementlist.length;
                              for(int i=0;i<len;i++)
                              {
                                mystorage.movementlist.add(0);
                                mystorage.movementdtlist.add(0);
                              }
